...
TEST(IntegrationTest, FullCycle) {
    ...
    ASSERT_TRUE(converter.LoadConfig("../tests/test_data/test_config.json", error)) << error;
    ASSERT_TRUE(converter.LoadRequests("../tests/test_data/test_requests.json", error)) << error;
